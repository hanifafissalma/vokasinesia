...
<?php 
    $title = "Pencarian ".ucwords($_GET['subtype']);
...
if( (!isset($_GET['s'])) || ($_GET['s']=="")){ $_GET['s']="-"; }
    $total = totaldataCari(rClean($_GET['s']));
    $paging = halaman($_GET['p'], 10, $total);
    $data = listdataPageCari($_GET['p'], 10,  rClean($_GET['s']));
?>
    ...
    <div class="archive">
        <div class="container wrapper">
        	<div class="archive-content">
                <div class="row">
                    <div class="col-md-12">
                    	<h1 class="h1-nonbg">Pencarian  "<?= htmlentities(rClean($_GET['s'])) ?>"</h1>
                    </div>
                    <div class="col-md-8">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                    	...
                                    	<div class="archive-whitearea-box-misc">
                                                <i class="fa fa-calendar text-orange"></i> <?= toViewDate($data[$key]['date_create']) ?>
                                                <i class="fa fa-folder-open ml-4 text-red"></i><a href="arsip/<?= $data[$key]['subtype'] ?>" title="arsip <?= $data[$key]['subtype'] ?>"> Berita</a>
                              ...
                              <ul class="pagination justify-content-center">
                                ...
                                { // Jika page bukan page ke 1
                                    ...
                                    $depan = '<li class="page-item">
                                                    <a class="page-link" href="pencarian/'.$_GET['s'].'/'.$link_prev.'/" aria-label="Previous">
                                                    <span aria-hidden="true">&laquo;</span>
                                                    <span class="sr-only">Previous</span>
                                                    </a>
                                                </li>';
                                ...
                                ?>
                                <li class="page-item <?php echo $link_active; ?>"><a class="page-link" href="pencarian/<?= $_GET['s'] ?>/<?php echo $i; ?>/"><?php echo $i; ?></a></li>
                                <?php                 
                                }
                                ...
                                if($page == $jumlah_page){ // Jika page terakhir
                                    ...
                                    $ekor ='<li class="page-item">
                                                <a class="page-link" href="pencarian/'.$_GET['s'].'/'.$link_next.'/" aria-label="Next">
                                                <span aria-hidden="true">&raquo;</span>
                                                <span class="sr-only">Next</span>
                                                </a>
                                            </li>';
